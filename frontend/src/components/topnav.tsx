...
function TopNav() {
    ...
    return (
        <div className="bg-background py-3 px-3 sm:px-10 flex items-center justify-between">
            ...
            <div className={`absolute top-0 left-0 z-10 w-full h-screen bg-white/20 rounded-lg shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-sm border border-white/30 transform transition-transform duration-300 ease-in-out ${
                ...
                <div className="py-3 px-3 sm:px-10 flex items-center justify-between">
                    <Link to="/" className="brand"><Logo/></Link>
                ...
                <ul className="flex justify-start items-start flex-col ps-5">
                    <li className="text-background p-2 text-start font-bold hover:text-orange-700 hover:underline underline-offset-8 transition ease-in-out delay-100"><Link to="/">Home</Link></li>
                    <SignedIn>
                    ...
                    <SignedOut>
                        <li className="text-background p-2 text-start font-bold hover:text-orange-700 hover:underline underline-offset-8 transition ease-in-out delay-100"><Link to="/sign-in">Sign In</Link></li>
                    </SignedOut>
                </ul>
            </div> 
        </div>
